...
router.get('/walkers/summary', async(req, res) => {
  const [rows] = await db.query(`
    SELECT Users.walker_username, Dogs.name AS dog_name, WalkRequests.requested_time, WalkRequests.duration_minutes, WalkRequests.location, Users.username AS owner_username
